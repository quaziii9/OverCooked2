...
public class Player3InteractController_Net : NetworkBehaviour
{
    // 애니메이션
    ...
    private Player2MasterController2_Net masterController;
    ...
    private void Awake()
    {
        masterController = PlayerInputSystem.GetComponent<Player2MasterController2_Net>();
    ...
    {
        PlayerInputSystem.GetComponent<Player2MasterController2_Net>().SwitchPlayerComponent();
    }
    #endregion
